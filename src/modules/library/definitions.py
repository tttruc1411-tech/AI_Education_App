...
LIBRARY_FUNCTIONS = {
    "Camera": {
        ...
        "functions": {
            ...
            "Set_Camera_Resolution": {
                "desc": "Change the camera capture resolution",
                "desc_vi": "Thay đổi độ phân giải chụp của camera",
                "params": [
                    {"name": "capture_camera", "type": "Capture Object", "desc": "The camera handle returned by Init_Camera", "desc_vi": "Đối tượng camera được trả về từ Init_Camera"},
                    {"name": "width", "type": "Number (int)", "desc": "Target width in pixels (default: 640)", "desc_vi": "Chiều rộng mong muốn (pixel) (mặc định: 640)"},
                    {"name": "height", "type": "Number (int)", "desc": "Target height in pixels (default: 480)", "desc_vi": "Chiều cao mong muốn (pixel) (mặc định: 480)"},
                ],
                "returns": {"type": "None", "desc": "Sets camera resolution in-place", "desc_vi": "Thiết lập độ phân giải camera trực tiếp"},
                "usage": "camera.Set_Camera_Resolution(capture_camera = None, width = '640', height = '480')",
                "import_statement": "import camera",
                "source_func": "Set_Camera_Resolution",
                "source_module": "src.modules.library.functions.camera_blocks",
            },
            "Capture_Snapshot": {
                "desc": "Capture a single frame with optional countdown delay",
                "desc_vi": "Chụp một khung hình đơn với tùy chọn đếm ngược",
                "params": [
                    {"name": "capture_camera", "type": "Capture Object", "desc": "The camera handle returned by Init_Camera", "desc_vi": "Đối tượng camera được trả về từ Init_Camera"},
                    {"name": "countdown", "type": "Number (int)", "desc": "Seconds to count down before capture (default: 0)", "desc_vi": "Số giây đếm ngược trước khi chụp (mặc định: 0)"},
                ],
                "returns": {"type": "Image (ndarray)", "desc": "The captured snapshot frame", "desc_vi": "Khung hình ảnh chụp được"},
                "usage": "snapshot = camera.Capture_Snapshot(capture_camera = None, countdown = '0')",
                "import_statement": "import camera",
                "source_func": "Capture_Snapshot",
                "source_module": "src.modules.library.functions.camera_blocks",
            },
        },
    },
    "Image Processing": {
        ...
        "functions": {
            ...
            "threshold_image": {
                "desc": "Apply binary thresholding to convert image to black/white at a cutoff value",
                "desc_vi": "Áp dụng ngưỡng nhị phân để chuyển ảnh thành đen/trắng tại giá trị ngưỡng",
                "params": [
                    {"name": "input_image", "type": "Image (ndarray)", "desc": "The input image to threshold", "desc_vi": "Hình ảnh đầu vào cần áp dụng ngưỡng"},
                    {"name": "threshold", "type": "Number (int)", "desc": "Cutoff value for thresholding (default: 127)", "desc_vi": "Giá trị ngưỡng cắt (mặc định: 127)"},
                    {"name": "max_value", "type": "Number (int)", "desc": "Maximum value assigned to pixels above threshold (default: 255)", "desc_vi": "Giá trị tối đa gán cho điểm ảnh trên ngưỡng (mặc định: 255)"},
                ],
                "returns": {"type": "Image (ndarray)", "desc": "Binary thresholded image (black and white)", "desc_vi": "Ảnh đã áp dụng ngưỡng nhị phân (đen và trắng)"},
                "usage": "binary_image = image.threshold_image(input_image = None, threshold = '127', max_value = '255')",
                "import_statement": "import image",
                "source_func": "threshold_image",
                "source_module": "src.modules.library.functions.image_processing",
            },
            "blend_images": {
                "desc": "Blend two images together with adjustable transparency weight",
                "desc_vi": "Trộn hai hình ảnh với trọng số độ trong suốt có thể điều chỉnh",
                "params": [
                    {"name": "image1", "type": "Image (ndarray)", "desc": "The first (base) image", "desc_vi": "Hình ảnh thứ nhất (ảnh nền)"},
                    {"name": "image2", "type": "Image (ndarray)", "desc": "The second (overlay) image", "desc_vi": "Hình ảnh thứ hai (ảnh phủ)"},
                    {"name": "alpha", "type": "Number (float)", "desc": "Blend weight for image1 from 0.0 to 1.0 (default: 0.5)", "desc_vi": "Trọng số trộn cho ảnh 1 từ 0.0 đến 1.0 (mặc định: 0.5)"},
                ],
                "returns": {"type": "Image (ndarray)", "desc": "Blended image combining both inputs", "desc_vi": "Ảnh đã trộn kết hợp cả hai đầu vào"},
                "usage": "blended = image.blend_images(image1 = None, image2 = None, alpha = '0.5')",
                "import_statement": "import image",
                "source_func": "blend_images",
                "source_module": "src.modules.library.functions.image_processing",
            },
            "split_channels": {
                "desc": "Split a color image into 3 separate B, G, R channel images",
                "desc_vi": "Tách ảnh màu thành 3 ảnh kênh B, G, R riêng biệt",
                "params": [
                    {"name": "input_image", "type": "Image (ndarray)", "desc": "A color (BGR) image to split", "desc_vi": "Ảnh màu (BGR) cần tách kênh"},
                ],
                "returns": {"type": "List", "desc": "List of 3 single-channel images [Blue, Green, Red]", "desc_vi": "Danh sách 3 ảnh đơn kênh [Xanh dương, Xanh lá, Đỏ]"},
                "usage": "channels = image.split_channels(input_image = None)",
                "import_statement": "import image",
                "source_func": "split_channels",
                "source_module": "src.modules.library.functions.image_processing",
            },
            "equalize_histogram": {
                "desc": "Enhance image contrast using histogram equalization",
                "desc_vi": "Tăng cường độ tương phản ảnh bằng cân bằng histogram",
                "params": [
                    {"name": "input_image", "type": "Image (ndarray)", "desc": "The input image to enhance", "desc_vi": "Hình ảnh đầu vào cần tăng cường"},
                ],
                "returns": {"type": "Image (ndarray)", "desc": "Contrast-enhanced image", "desc_vi": "Ảnh đã tăng cường độ tương phản"},
                "usage": "enhanced = image.equalize_histogram(input_image = None)",
                "import_statement": "import image",
                "source_func": "equalize_histogram",
                "source_module": "src.modules.library.functions.image_processing",
            },
            "detect_contours": {
                "desc": "Find and draw object contours/outlines on the image",
                "desc_vi": "Tìm và vẽ đường viền/đường bao đối tượng trên ảnh",
                "params": [
                    {"name": "input_image", "type": "Image (ndarray)", "desc": "The input image to find contours in", "desc_vi": "Hình ảnh đầu vào để tìm đường viền"},
                ],
                "returns": {"type": "Image (ndarray)", "desc": "Image with contours drawn in green", "desc_vi": "Ảnh có đường viền được vẽ màu xanh lá"},
                "usage": "contour_image = image.detect_contours(input_image = None)",
                "import_statement": "import image",
                "source_func": "detect_contours",
                "source_module": "src.modules.library.functions.image_processing",
            },
        },
    },
    "AI Vision Core": {
        ...
        "functions": {
            ...
            "Get_Detection_Count": {
                "desc": "Extract the number of detections from AI model results",
                "desc_vi": "Trích xuất số lượng phát hiện từ kết quả mô hình AI",
                "params": [
                    {"name": "results", "type": "Array", "desc": "The detection results from any AI model (YuNet, ONNX, or Engine)", "desc_vi": "Kết quả phát hiện từ bất kỳ mô hình AI nào (YuNet, ONNX, hoặc Engine)"},
                ],
                "returns": {"type": "Number (int)", "desc": "The number of objects detected", "desc_vi": "Số lượng đối tượng phát hiện được"},
                "usage": "count = ai_vision.Get_Detection_Count(results = None)",
                "import_statement": "import ai_vision",
                "source_func": "Get_Detection_Count",
                "source_module": "src.modules.library.functions.ai_vision_blocks",
            },
            "Crop_Detection": {
                "desc": "Crop a detected object region from the frame by index",
                "desc_vi": "Cắt vùng đối tượng phát hiện được từ khung hình theo chỉ số",
                "params": [
                    {"name": "camera_frame", "type": "Image", "desc": "The camera frame containing detected objects", "desc_vi": "Khung hình camera chứa các đối tượng phát hiện được"},
                    {"name": "results", "type": "Array", "desc": "The detection results from any AI model", "desc_vi": "Kết quả phát hiện từ bất kỳ mô hình AI nào"},
                    {"name": "index", "type": "Number (int)", "desc": "Index of the detection to crop (default: 0)", "desc_vi": "Chỉ số của phát hiện cần cắt (mặc định: 0)"},
                ],
                "returns": {"type": "Image (ndarray)", "desc": "Cropped image of the detected object, or None if index out of range", "desc_vi": "Ảnh cắt của đối tượng phát hiện được, hoặc None nếu chỉ số ngoài phạm vi"},
                "usage": "cropped = ai_vision.Crop_Detection(camera_frame = None, results = None, index = '0')",
                "import_statement": "import ai_vision",
                "source_func": "Crop_Detection",
                "source_module": "src.modules.library.functions.ai_vision_blocks",
            },
        },
    },
    "Display & Dashboard": {
        ...
        "functions": {
            ...
            "Draw_Line": {
                "desc": "Draw a colored line on the camera frame",
                "desc_vi": "Vẽ đường thẳng có màu lên khung hình camera",
                "params": [
                    {"name": "camera_frame", "type": "Image", "desc": "The camera frame to draw on", "desc_vi": "Khung hình camera để vẽ lên"},
                    {"name": "x1", "type": "Number (int)", "desc": "Starting X coordinate in pixels", "desc_vi": "Tọa độ X bắt đầu (pixel)"},
                    {"name": "y1", "type": "Number (int)", "desc": "Starting Y coordinate in pixels", "desc_vi": "Tọa độ Y bắt đầu (pixel)"},
                    {"name": "x2", "type": "Number (int)", "desc": "Ending X coordinate in pixels", "desc_vi": "Tọa độ X kết thúc (pixel)"},
                    {"name": "y2", "type": "Number (int)", "desc": "Ending Y coordinate in pixels", "desc_vi": "Tọa độ Y kết thúc (pixel)"},
                    {"name": "color", "type": "Text (str)", "desc": "Color name: green, red, blue, yellow, white (default: 'green')", "desc_vi": "Tên màu: green, red, blue, yellow, white (mặc định: 'green')"},
                ],
                "returns": {"type": "Image (ndarray)", "desc": "Frame with line drawn", "desc_vi": "Khung hình có đường thẳng được vẽ"},
                "usage": "lined = display.Draw_Line(camera_frame = None, x1 = '0', y1 = '0', x2 = '100', y2 = '100', color = 'green')",
                "import_statement": "import display",
                "source_func": "Draw_Line",
                "source_module": "src.modules.library.functions.display_blocks",
            },
            "Draw_Text_Box": {
                "desc": "Draw text with a colored background box for labels",
                "desc_vi": "Vẽ chữ với hộp nền có màu để làm nhãn",
                "params": [
                    {"name": "camera_frame", "type": "Image", "desc": "The camera frame to draw on", "desc_vi": "Khung hình camera để vẽ lên"},
                    {"name": "text", "type": "Text (str)", "desc": "The text to display", "desc_vi": "Chữ cần hiển thị"},
                    {"name": "x", "type": "Number (int)", "desc": "Left position in pixels", "desc_vi": "Vị trí bên trái (pixel)"},
                    {"name": "y", "type": "Number (int)", "desc": "Top position in pixels", "desc_vi": "Vị trí phía trên (pixel)"},
                    {"name": "bg_color", "type": "Text (str)", "desc": "Background box color name (default: 'blue')", "desc_vi": "Tên màu nền hộp (mặc định: 'blue')"},
                    {"name": "text_color", "type": "Text (str)", "desc": "Text color name (default: 'white')", "desc_vi": "Tên màu chữ (mặc định: 'white')"},
                ],
                "returns": {"type": "Image (ndarray)", "desc": "Frame with labeled text box drawn", "desc_vi": "Khung hình có hộp chữ nhãn được vẽ"},
                "usage": "labeled = display.Draw_Text_Box(camera_frame = None, text = 'Label', x = '10', y = '30', bg_color = 'blue', text_color = 'white')",
                "import_statement": "import display",
                "source_func": "Draw_Text_Box",
                "source_module": "src.modules.library.functions.display_blocks",
            },
            "Stack_Images": {
                "desc": "Stack two images side-by-side or top-bottom for comparison",
                "desc_vi": "Xếp chồng hai hình ảnh cạnh nhau hoặc trên-dưới để so sánh",
                "params": [
                    {"name": "image1", "type": "Image (ndarray)", "desc": "The first image", "desc_vi": "Hình ảnh thứ nhất"},
                    {"name": "image2", "type": "Image (ndarray)", "desc": "The second image", "desc_vi": "Hình ảnh thứ hai"},
                    {"name": "direction", "type": "Text (str)", "desc": "Stack direction: 'horizontal' or 'vertical' (default: 'horizontal')", "desc_vi": "Hướng xếp: 'horizontal' (ngang) hoặc 'vertical' (dọc) (mặc định: 'horizontal')"},
                ],
                "returns": {"type": "Image (ndarray)", "desc": "Combined image with both inputs stacked", "desc_vi": "Ảnh kết hợp với cả hai đầu vào được xếp chồng"},
                "usage": "combined = display.Stack_Images(image1 = None, image2 = None, direction = 'horizontal')",
                "import_statement": "import display",
                "source_func": "Stack_Images",
                "source_module": "src.modules.library.functions.display_blocks",
            },
        },
    },
    ...
    "Logic Operations": {
        ...
        "functions": {
            ...
            "Get_Timestamp": {
                "desc": "Get the current date and time as a formatted string",
                "desc_vi": "Lấy ngày và giờ hiện tại dưới dạng chuỗi định dạng",
                "params": [],
                "returns": {"type": "Text (str)", "desc": "Current date and time as 'YYYY-MM-DD HH:MM:SS'", "desc_vi": "Ngày và giờ hiện tại dạng 'YYYY-MM-DD HH:MM:SS'"},
                "usage": "timestamp = logic.Get_Timestamp()",
                "import_statement": "import logic",
                "source_func": "Get_Timestamp",
                "source_module": "src.modules.library.functions.logic_blocks",
            },
            "Compare_Values": {
                "desc": "Compare two values and return True if equal, False otherwise",
                "desc_vi": "So sánh hai giá trị và trả về True nếu bằng nhau, False nếu khác",
                "params": [
                    {"name": "value1", "type": "Any", "desc": "The first value to compare", "desc_vi": "Giá trị thứ nhất để so sánh"},
                    {"name": "value2", "type": "Any", "desc": "The second value to compare", "desc_vi": "Giá trị thứ hai để so sánh"},
                ],
                "returns": {"type": "Boolean", "desc": "True if values are equal, False otherwise", "desc_vi": "True nếu hai giá trị bằng nhau, False nếu khác"},
                "usage": "is_equal = logic.Compare_Values(value1 = None, value2 = None)",
                "import_statement": "import logic",
                "source_func": "Compare_Values",
                "source_module": "src.modules.library.functions.logic_blocks",
            },
        }
    },
    ...
    "Robotics": {
        ...
        "functions": {
            ...
            "Sweep_Servo": {
                "desc": "Smoothly sweep a servo motor across an angle range",
                "desc_vi": "Quét mượt động cơ servo qua một phạm vi góc",
                "params": [
                    {"name": "pin", "type": "Text (str)", "desc": "Servo port: 'S1', 'S2', 'S3', or 'S4' (default: 'S1')", "desc_vi": "Cổng servo: 'S1', 'S2', 'S3', hoặc 'S4' (mặc định: 'S1')"},
                    {"name": "start_angle", "type": "Number (int)", "desc": "Starting angle in degrees (default: 0)", "desc_vi": "Góc bắt đầu tính bằng độ (mặc định: 0)"},
                    {"name": "end_angle", "type": "Number (int)", "desc": "Ending angle in degrees (default: 180)", "desc_vi": "Góc kết thúc tính bằng độ (mặc định: 180)"},
                    {"name": "step", "type": "Number (int)", "desc": "Angle increment per step (default: 10)", "desc_vi": "Bước tăng góc mỗi lần (mặc định: 10)"},
                    {"name": "delay", "type": "Number (float)", "desc": "Pause in seconds between steps (default: 0.05)", "desc_vi": "Thời gian dừng giữa các bước tính bằng giây (mặc định: 0.05)"},
                ],
                "returns": {"type": "None", "desc": "Servo sweeps through the angle range", "desc_vi": "Servo quét qua phạm vi góc"},
                "usage": "robotics.Sweep_Servo(pin = 'S1', start_angle = 0, end_angle = 180, step = 10, delay = 0.05)",
                "import_statement": "import robotics",
                "source_func": "Sweep_Servo",
                "source_module": "src.modules.library.functions.robotics",
            },
        }
    },
