...
while True:
    ...
    engine_results = Run_Engine_Model(engine_model = engine_model, camera_frame = camera_frame, img_size = 640)

    # Step 6: Draw boxes on detected objects (Draw_Engine_Detections)
    obj_count = Draw_Engine_Detections(camera_frame = camera_frame, results = engine_results, classes = classes, conf_threshold = 0.25)
